#!/bin/bash
# DepthMem fine-tuning script for GR00T N1.6
#
# Starts from bridge-finetuned checkpoint (not pretrained) and adds
# DepthMem: 4ch RGBD input + temporal attention in SigLIP2.
#
# Prerequisites:
#   1. Generate depth maps: python scripts/generate_depth_maps.py \
#        --data_dir /path/to/bridge_lerobot --output_dir /path/to/depth_maps
#   2. Bridge-finetuned checkpoint at MODEL_PATH
#
# Usage:
...
OUTPUT_DIR="/mnt/md1/solee/checkpoints/GR00T-N1.6-depthmem"
