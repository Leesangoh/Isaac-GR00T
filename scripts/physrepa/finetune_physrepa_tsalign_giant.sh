...
torchrun --nproc_per_node=$NUM_GPUS --master_port=29504 \
    ...
    --num_gpus $NUM_GPUS \
    --output_dir /mnt/md1/solee/checkpoints/physrepa_tsalign_vitg/ \
    --save_steps 1000 \
    --save_total_limit 5 \
    --max_steps 20000 \
    --warmup_ratio 0.05 \
    ...
    --physrepa-enabled \
    --physrepa-lambda 0.5 \
    --physrepa-vjepa-features-dir /mnt/md1/solee/features/vjepa2_vitg/ \
    --physrepa-vjepa-layer 16 \
    --physrepa-vjepa-dim 1408 \
    --physrepa-align-layers 0 1 2 3 4 5 6 7 8 \
    --physrepa-global-means-path /mnt/md1/solee/features/vjepa2_vitg/global_means.pt \
